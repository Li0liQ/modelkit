...
})(this, function(__WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_329__) {
...
Func = __webpack_require__(309);
List = __webpack_require__(310);
Obj = __webpack_require__(312);
Str = __webpack_require__(313);
Num = __webpack_require__(311);
id = function(x){
  return x;
};
...
module.exports = __webpack_require__(144)('forEach');
...
(function(){
  ...
  ref$ = __webpack_require__(3), each = ref$.each, keys = ref$.keys, difference = ref$.difference, intersection = ref$.intersection;
  syntax = {
    Misc: {
      Program: {
        alias: 'program',
...
module.exports = __webpack_require__(167)() ? Symbol : __webpack_require__(169);
...
var toPosInt = __webpack_require__(6)
...
(function(){
  ...
  VERSION = '0.3.2';
  parseType = __webpack_require__(317);
  parsedTypeCheck = __webpack_require__(316);
...
var assign   = __webpack_require__(13)
  ...
  , forOwn   = __webpack_require__(9)
  , onlyKey  = __webpack_require__(149)
  , forEachRight = __webpack_require__(128)
  , uniq = __webpack_require__(129);
...
var stringifiable = __webpack_require__(38)
...
var toString = Object.prototype.toString
  ...
  , id = toString.call(__webpack_require__(135));
...
var value         = __webpack_require__(1)
  , stringifiable = __webpack_require__(38);
...
var clear    = __webpack_require__(127)
...
(function(){
  ...
  attrMap = __webpack_require__(10).attrMap;
...
(function(){
  ...
  syntaxFlat = __webpack_require__(10).syntaxFlat;
  function Cache(ast){
    var nodes, types;
    this.ast = ast;
    nodes = [];
...
(function(){
  ...
  optionator = __webpack_require__(308);
  options = [
    {
...
(function(){
  ...
  parseString = __webpack_require__(187);
  cast = __webpack_require__(186);
  parseType = __webpack_require__(52).parseType;
  VERSION = '0.3.0';
...
var arrayFilter = __webpack_require__(75),
    baseFilter = __webpack_require__(200),
    baseIteratee = __webpack_require__(41),
    isArray = __webpack_require__(2);
...
var baseFlatten = __webpack_require__(78),
    baseRest = __webpack_require__(220),
    baseUniq = __webpack_require__(225),
...
var normalizeOpts = __webpack_require__(23)
  , resolveLength = __webpack_require__(50)
  , plain         = __webpack_require__(305);
	...
	if (!options.normalizer) {
		...
		if (length !== 0) {
			if (options.primitive) {
				if (length === false) {
					options.normalizer = __webpack_require__(304);
				} else if (length > 1) {
					options.normalizer = __webpack_require__(302)(length);
				}
			} else {
				if (length === false) options.normalizer = __webpack_require__(303)();
				else if (length === 1) options.normalizer = __webpack_require__(300)();
				else options.normalizer = __webpack_require__(301)(length);
			}
		}
	}

	// Assure extensions
	if (options.async) __webpack_require__(289);
	if (options.promise) __webpack_require__(293);
	if (options.dispose) __webpack_require__(290);
	if (options.maxAge) __webpack_require__(291);
	if (options.max) __webpack_require__(292);
	if (options.refCounter) __webpack_require__(294);
...
var toPosInt   = __webpack_require__(6)
  , maxTimeout = __webpack_require__(315);
...
const userHome = __webpack_require__(327).default;
...
var _modelkitJsonLoader = __webpack_require__(107);
...
var _modelkitJsLoader = __webpack_require__(106);
...
var _modelkitYarnLoader = __webpack_require__(108);
...
var _mkdirp = __webpack_require__(306);
...
var _union = __webpack_require__(97);

var _union2 = _interopRequireDefault(_union);

var _flagUtils = __webpack_require__(110);
...
var _modelkitFreezePlugin = __webpack_require__(109);
...
var _modelkit = __webpack_require__(103);
...
var _loaders = __webpack_require__(102);
...
var _grasp = __webpack_require__(181);
...
var JsLoader = function () {
    ...
    _createClass(JsLoader, [{
        ...
        value: function readFiles(inputDir) {
            ...
            this.files = (0, _map2.default)(this.config.files, function (fileName) {
                ...
                var flags = (0, _map2.default)(foundResult, function (i) {
...
var object        = __webpack_require__(155)
  , stringifiable = __webpack_require__(65)
...
var d              = __webpack_require__(4)
  ...
  , primitiveSet   = __webpack_require__(154)
  , setPrototypeOf = __webpack_require__(37)
  , memoize        = __webpack_require__(98)
  , memoizeMethods = __webpack_require__(299)

  , sgr = __webpack_require__(56)
  , mods = sgr.mods
...
if (process.platform === 'win32') xtermMatch = __webpack_require__(118);
...
var from              = __webpack_require__(16)
  , iterable          = __webpack_require__(137)
  , stringifiable     = __webpack_require__(38)
  , repeat            = __webpack_require__(158)
  , getStrippedLength = __webpack_require__(36);
...
module.exports = Object.defineProperties(__webpack_require__(112), {
	windowSize: d(__webpack_require__(123)),
	erase: d(__webpack_require__(115)),
	move: d(__webpack_require__(119)),
	beep: d(__webpack_require__(113)),
	columns: d(__webpack_require__(114)),
	strip: d(__webpack_require__(57)),
	getStrippedLength: d(__webpack_require__(36)),
	slice: d(__webpack_require__(121)),
	throbber: d(__webpack_require__(122)),
	reset: d(__webpack_require__(120)),
	art: d(__webpack_require__(111))
});
...
colors = __webpack_require__(117).map(function (color) {
	return {
...
var reAnsi        = __webpack_require__(55)
  , stringifiable = __webpack_require__(65)
  , length        = __webpack_require__(36)
  , sgr           = __webpack_require__(56)
...
var compose      = __webpack_require__(134)
  , callable     = __webpack_require__(0)
  , d            = __webpack_require__(4)
  , validTimeout = __webpack_require__(100)
...
var copy             = __webpack_require__(147)
...
var iteratorSymbol = __webpack_require__(18).iterator
  , isArguments    = __webpack_require__(21)
  , isFunction     = __webpack_require__(59)
  , toPosInt       = __webpack_require__(6)
  , callable       = __webpack_require__(0)
  , validValue     = __webpack_require__(1)
...
var isArguments    = __webpack_require__(21)
  , isString       = __webpack_require__(25)
  , ArrayIterator  = __webpack_require__(161)
  , StringIterator = __webpack_require__(165)
  , iterable       = __webpack_require__(166)
...
var isIterable = __webpack_require__(164);
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;(function() {
  ...
  // amd
  if ("function" !== "undefined" && __webpack_require__(318) !== null && __webpack_require__(319)) {
...
(function(){
  ...
  parse = __webpack_require__(175).parse;
  matchNode = __webpack_require__(174).matchNode;
  VERSION = '0.3.2';
...
(function(){
  ...
  ref$ = __webpack_require__(10), primitiveOnlyAttributes = ref$.primitiveOnlyAttributes, eitherAttributes = ref$.eitherAttributes, syntaxFlat = ref$.syntaxFlat;
  ref$ = __webpack_require__(3), all = ref$.all, tail = ref$.tail;
  getNodeAtPath = __webpack_require__(67).getNodeAtPath;
...
(function(){
  ...
  acorn = __webpack_require__(54);
  ref$ = __webpack_require__(10), aliasMap = ref$.aliasMap, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap, literalMap = ref$.literalMap;
  getNodeAtPath = __webpack_require__(67).getNodeAtPath;
...
(function(){
  ...
  VERSION = '0.3.1';
  Cache = __webpack_require__(68).Cache;
  parse = __webpack_require__(178).parse;
  ref$ = __webpack_require__(177), finalMatches = ref$.finalMatches, matchAst = ref$.matchAst;
...
(function(){
  ...
  ref$ = __webpack_require__(3), map = ref$.map, any = ref$.any, all = ref$.all;
  ref$ = __webpack_require__(10), literalMap = ref$.literalMap, syntaxFlat = ref$.syntaxFlat;
  ref$ = __webpack_require__(68), Cache = ref$.Cache, visitPre = ref$.visitPre, visitChildren = ref$.visitChildren, getPath = ref$.getPath;
...
(function(){
  ...
  ref$ = __webpack_require__(3), map = ref$.map, last = ref$.last, lines = ref$.lines, compact = ref$.compact, join = ref$.join;
  ref$ = __webpack_require__(10), aliasMap = ref$.aliasMap, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap, literalMap = ref$.literalMap, complexTypeMap = ref$.complexTypeMap, attrMap = ref$.attrMap, primitiveOnlyAttributes = ref$.primitiveOnlyAttributes, eitherAttributes = ref$.eitherAttributes;
  function parse(selector){
...
(function(){
  ...
  ref$ = __webpack_require__(3), id = ref$.id, compact = ref$.compact, unlines = ref$.unlines, min = ref$.min, max = ref$.max;
  module.exports = {
...
(function(){
  ...
  ref$ = __webpack_require__(3), map = ref$.map, flatten = ref$.flatten, join = ref$.join, lines = ref$.lines, unlines = ref$.unlines, chars = ref$.chars, unchars = ref$.unchars;
  ref$ = __webpack_require__(10), syntax = ref$.syntax, syntaxFlat = ref$.syntaxFlat, aliasMap = ref$.aliasMap, attrMapInverse = ref$.attrMapInverse, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap;
  pad = __webpack_require__(183).pad;
  options = __webpack_require__(69).options;
...
(function(){
  ...
  acorn = __webpack_require__(54);
  squery = __webpack_require__(176);
  equery = __webpack_require__(173);
  async = __webpack_require__(184);
  ref$ = __webpack_require__(3), min = ref$.min, sortWith = ref$.sortWith, lines = ref$.lines, chars = ref$.chars, split = ref$.split, join = ref$.join, map = ref$.map, Obj = ref$.Obj;
  format = __webpack_require__(179), formatResult = format.formatResult, formatName = format.formatName, formatCount = format.formatCount;
  replace = __webpack_require__(182).replace;
  ref$ = __webpack_require__(69), parseOptions = ref$.parse, generateHelp = ref$.generateHelp, generateHelpForOption = ref$.generateHelpForOption;
  help = __webpack_require__(180);
  _console = console;
  version = '0.4.0';
  run = function(arg$){
    ...
    ref$ = arg$ != null
      ...
      ? ref1$
      : __webpack_require__(15), textFormat = (ref1$ = ref$.textFormat) != null
      ? ref1$
      : __webpack_require__(116), input = ref$.input, console = (ref1$ = ref$.console) != null ? ref1$ : _console;
    if (args == null) {
    ...
    ref$ = (function(){
      ...
      default:
        return null//[require(options.parser[0]), options.parser[1]];
      }
...
(function(){
  ...
  ref$ = __webpack_require__(3), lines = ref$.lines, unlines = ref$.unlines, filter = ref$.filter, fold = ref$.fold, capitalize = ref$.capitalize, camelize = ref$.camelize, dasherize = ref$.dasherize;
  levn = __webpack_require__(71);
...
(function(){
  ...
  parsedTypeCheck = __webpack_require__(52).parsedTypeCheck;
  types = {
...
var aFrom        = __webpack_require__(16)
  , objectMap    = __webpack_require__(17)
  , mixin        = __webpack_require__(62)
  , defineLength = __webpack_require__(58)
  , nextTick     = __webpack_require__(51)
...
var callable   = __webpack_require__(0)
  , forEach    = __webpack_require__(9)
  , extensions = __webpack_require__(7)
...
var aFrom      = __webpack_require__(16)
  , forEach    = __webpack_require__(9)
  , nextTick   = __webpack_require__(51)
  , isPromise  = __webpack_require__(70)
  , timeout    = __webpack_require__(100)
  , extensions = __webpack_require__(7)
...
var toPosInteger = __webpack_require__(6)
  , lruQueue     = __webpack_require__(288)
  , extensions   = __webpack_require__(7);
...
var objectMap = __webpack_require__(17)
  , isPromise = __webpack_require__(70)
  , nextTick  = __webpack_require__(51)
...
var customError      = __webpack_require__(133)
  , defineLength     = __webpack_require__(58)
  , d                = __webpack_require__(4)
  , ee               = __webpack_require__(171).methods
  , resolveResolve   = __webpack_require__(298)
  , resolveNormalize = __webpack_require__(297)
...
module.exports = __webpack_require__(296)(__webpack_require__(98));
...
var callable      = __webpack_require__(0)
  , forEach       = __webpack_require__(9)
  , extensions    = __webpack_require__(7)
  , configure     = __webpack_require__(295)
  , resolveLength = __webpack_require__(50)
...
(function(){
  ...
  ref$ = __webpack_require__(99), nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin;
  wordwrap = __webpack_require__(320);
...
(function(){
  ...
  deepIs = __webpack_require__(126);
  ref$ = __webpack_require__(99), closestString = ref$.closestString, nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin;
  ref$ = __webpack_require__(307), generateHelp = ref$.generateHelp, generateHelpForOption = ref$.generateHelpForOption;
  ref$ = __webpack_require__(52), parsedTypeCheck = ref$.parsedTypeCheck, parseType = ref$.parseType;
  parseLevn = __webpack_require__(71).parsedTypeParse;
...
function _load_constants() {
  return _constants = __webpack_require__(101);
}

var _errors;

function _load_errors() {
  return _errors = __webpack_require__(321);
}

var _map;

function _load_map() {
  return _map = _interopRequireDefault(__webpack_require__(324));
}

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const invariant = __webpack_require__(185);
/* eslint quotes: 0 */

const stripBOM = __webpack_require__(314);
...
function _load_misc() {
  return _misc = __webpack_require__(325);
}
...
const _camelCase = __webpack_require__(328);
...
function _load_rootUser() {
  return _rootUser = _interopRequireDefault(__webpack_require__(326));
}
...
const userHomeDir = process.platform === 'linux' && (_rootUser || _load_rootUser()).default ? path.resolve('/usr/local/share') : __webpack_require__(329).homedir();
