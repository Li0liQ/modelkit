...
var Modelkit = function () {
    ...
    _createClass(Modelkit, [{
        ...
        value: function run(config) {
            ...
            var flags = this.getFlags(config.input);
            ...
            var getDirName = function getDirName(i) {
                return config.flagDirName.replace('[id]', i);
            };

            (0, _foreach2.default)(sortedFlags, function (i, index) {
                (0, _mkdirp2.default)(_path2.default.join(config.outputDir, getDirName(index)));
            });
        ...
        key: 'getFlags',
        value: function getFlags(input) {
            // we support only boolean flags for now
            // hence union and returning flag names only works fine
            var flags = (0, _union2.default)((0, _flatten2.default)((0, _map2.default)(input, function (i) {
                return i.getFlags();
            })));
