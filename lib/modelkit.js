...
var Modelkit = function () {
    ...
    _createClass(Modelkit, [{
        ...
        value: function run(config) {
            ...
            var featureFlagsToDirectoryMap = (0, _map3.default)(sortedFlags, function (flagObj, flagIndex) {
                return {
                    flags: flagObj,
            ...
            (0, _forEach3.default)(sortedFlags, function (flagObj, flagIndex) {
        ...
        value: function getFlags(config) {
            ...
            var flags = (0, _union3.default)((0, _flatten3.default)((0, _map3.default)(config.input, function (i) {
                return i.getFlags();
            })));
        ...
        value: function getFreezeFlags(input) {
            ...
            // Throw if there are.
            var freezeFlags = (0, _map3.default)(input, function (i) {
...
var JsLoader = function () {
    ...
    _createClass(JsLoader, [{
        ...
        value: function readFiles(inputDir) {
            ...
            this.files = (0, _map3.default)(this.config.files, function (fileName) {
        ...
        value: function getFlags() {
            var flags = (0, _union3.default)((0, _flatten3.default)((0, _map3.default)(this.files, function (i) {
                return i.flags;
            })));
        ...
        value: function applyFlags(flagObj, outputDir) {
            ...
            (0, _forEach3.default)(this.files, function (_ref) {
                ...
                _fs2.default.writeFileSync(_path2.default.join(outputDir, fileName), result);
            });
        }
    }]);
        ...
        value: function applyFlags(flagObj, outputDir) {
            ...
            (0, _forEach3.default)(this.files, function (_ref) {
                ...
                json = (0, _reduce3.default)(flagObj, function (agg, value, key) {
                    ...
                    var changes = (0, _filter3.default)(_this.config.changes, function (i) {
                        return i.flag === key;
                    })[0];
    ...
    _createClass(YarnLoader, [{
        ...
        value: function applyFlags(flagObj, outputDir) {
            ...
            (0, _forEach3.default)(this.files, function (_ref) {
                ...
                var json = (0, _parse2.default)(source, filePath);
                json = (0, _reduce3.default)(flagObj, function (agg, value, key) {
                    if (!value) {
                        return agg;
                    }
                ...
                _fs2.default.writeFileSync(_path2.default.join(outputDir, fileName), (0, _stringify2.default)(json, false));
            });
        }
    }]);
