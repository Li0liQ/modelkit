...
var Modelkit = function () {
    ...
    _createClass(Modelkit, [{
        ...
        value: function run(config) {
            ...
            context.flagPermutations = (0, _flagUtils.getBooleanFlagPermutations)(context.flags, config.freezeFlags);
        ...
        key: 'generateOutput',
        value: function generateOutput(config, context) {
            var _this = this;

            // for every permutation generate { folder, files }
            var result = (0, _map3.default)(context.flagPermutations, function (flagObj, flagIndex) {
                var outputItem = {};
                // TODO: allow plugins to provide additional replacements in filename
                var flagDirectory = _this.getDirectoryByFlag({ flagObj: flagObj, flagIndex: flagIndex, config: config });
                outputItem.directory = _path2.default.join(config.outputDir, flagDirectory);
                outputItem.flags = Object.assign({}, flagObj);
                outputItem.files = (0, _map3.default)(context.files, function (file) {
                    return Object.assign({}, file, {
                        parent: file,
                        source: file.loader ? file.loader.getFileSourceWithFlags(file, outputItem.flags) : file.source,
                        filePath: _path2.default.join(outputItem.directory, file.fileName)
                    });
                });
        ...
        key: 'flushOutput',
        value: function flushOutput(config, context) {
            (0, _mkdirp2.default)(config.outputDir);

            (0, _forEach3.default)(context.output, function (_ref) {
                var directory = _ref.directory,
                    files = _ref.files;

                (0, _mkdirp2.default)(directory);
                (0, _forEach3.default)(files, function (file) {
                    return _fs2.default.writeFileSync(file.filePath, file.source);
                });
            });
        }
    }, {
        ...
        value: function getAllFlags(files) {
            ...
            var flags = (0, _union3.default)((0, _flatten3.default)((0, _map3.default)((0, _filter3.default)(files, function (file) {
                return file.flags;
            }), function (file) {
                return file.flags;
            })));
...
var _modelkitIgnorePlugin = require('./modelkit-ignore-plugin');

Object.defineProperty(exports, 'ModelkitIgnorePlugin', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_modelkitIgnorePlugin).default;
  }
});
...
var ManifestPlugin = function () {
    ...
    _createClass(ManifestPlugin, [{
        ...
        value: function afterEnd(context) {
            var featureFlagsToDirectoryMap = (0, _map3.default)(context.output, function (_ref) {
...
___scope___.file("plugins/modelkit-ignore-plugin.js", function(exports, require, module, __filename, __dirname){
...
var IgnorePlugin = function () {
    ...
    _createClass(IgnorePlugin, [{
        key: 'afterGenerateOutput',
        value: function afterGenerateOutput(context) {
            var _this = this;

            (0, _forEach3.default)(context.output, function (outputItem) {
                if (!outputItem.flags[_this.config.flag] === true) {
                    return;
                }

                outputItem.files = (0, _filter3.default)(outputItem.files, function (file) {
                    return _this.config.files.indexOf(file.parent.fileName) === -1;
                });
            });
        }
    }]);
