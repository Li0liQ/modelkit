...
})(this, function(__WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_229__) {
...
Func = __webpack_require__(208);
List = __webpack_require__(209);
Obj = __webpack_require__(211);
Str = __webpack_require__(212);
Num = __webpack_require__(210);
id = function(x){
  return x;
};
...
(function(){
  ...
  ref$ = __webpack_require__(2), each = ref$.each, keys = ref$.keys, difference = ref$.difference, intersection = ref$.intersection;
  syntax = {
    Misc: {
      Program: {
        alias: 'program',
...
var callable = __webpack_require__(0)
...
module.exports = __webpack_require__(132)() ? Symbol : __webpack_require__(134);
...
(function(){
  ...
  VERSION = '0.3.2';
  parseType = __webpack_require__(216);
  parsedTypeCheck = __webpack_require__(215);
...
var assign   = __webpack_require__(9)
  ...
  , forOwn   = __webpack_require__(7)
  , onlyKey  = __webpack_require__(114)
  , forEachRight = __webpack_require__(93)
  , uniq = __webpack_require__(94);
...
var stringifiable = __webpack_require__(27)
...
var toString = Object.prototype.toString
  ...
  , id = toString.call(__webpack_require__(100));
...
var value         = __webpack_require__(1)
  , stringifiable = __webpack_require__(27);
...
var clear    = __webpack_require__(92)
  ...
  , callable = __webpack_require__(0)
  , value    = __webpack_require__(1)
...
(function(){
  ...
  attrMap = __webpack_require__(8).attrMap;
...
(function(){
  ...
  parse = __webpack_require__(139).parse;
  matchNode = __webpack_require__(138).matchNode;
  VERSION = '0.3.2';
...
(function(){
  ...
  syntaxFlat = __webpack_require__(8).syntaxFlat;
  function Cache(ast){
    var nodes, types;
    this.ast = ast;
    nodes = [];
...
(function(){
  ...
  VERSION = '0.3.1';
  Cache = __webpack_require__(49).Cache;
  parse = __webpack_require__(141).parse;
  ref$ = __webpack_require__(140), finalMatches = ref$.finalMatches, matchAst = ref$.matchAst;
...
(function(){
  ...
  optionator = __webpack_require__(207);
  options = [
    {
...
(function(){
  ...
  parseString = __webpack_require__(150);
  cast = __webpack_require__(149);
  parseType = __webpack_require__(33).parseType;
  VERSION = '0.3.0';
...
var baseFlatten = __webpack_require__(54),
    baseRest = __webpack_require__(166),
...
var normalizeOpts = __webpack_require__(18)
  , resolveLength = __webpack_require__(31)
  , plain         = __webpack_require__(204);
	...
	if (!options.normalizer) {
		...
		if (length !== 0) {
			if (options.primitive) {
				if (length === false) {
					options.normalizer = __webpack_require__(203);
				} else if (length > 1) {
					options.normalizer = __webpack_require__(201)(length);
				}
			} else {
				if (length === false) options.normalizer = __webpack_require__(202)();
				else if (length === 1) options.normalizer = __webpack_require__(199)();
				else options.normalizer = __webpack_require__(200)(length);
			}
		}
	}

	// Assure extensions
	if (options.async) __webpack_require__(188);
	if (options.promise) __webpack_require__(192);
	if (options.dispose) __webpack_require__(189);
	if (options.maxAge) __webpack_require__(190);
	if (options.max) __webpack_require__(191);
	if (options.refCounter) __webpack_require__(193);
...
(function(){
  ...
  prelude = __webpack_require__(2), map = prelude.map, sortBy = prelude.sortBy;
  fl = __webpack_require__(137);
...
var toPosInt   = __webpack_require__(4)
  , maxTimeout = __webpack_require__(214);
...
const userHome = __webpack_require__(227).default;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _modelkitJsonLoader=__webpack_require__(72);Object.defineProperty(exports,'ModelkitJsonLoader',{enumerable:!0,get:function get(){return _interopRequireDefault(_modelkitJsonLoader).default}});var _modelkitJsLoader=__webpack_require__(71);Object.defineProperty(exports,'ModelkitJsLoader',{enumerable:!0,get:function get(){return _interopRequireDefault(_modelkitJsLoader).default}});var _modelkitYarnLoader=__webpack_require__(73);Object.defineProperty(exports,'ModelkitYarnLoader',{enumerable:!0,get:function get(){return _interopRequireDefault(_modelkitYarnLoader).default}});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}
...
"use strict";
var _reduce2=__webpack_require__(30),_reduce3=_interopRequireDefault(_reduce2),_flatten2=__webpack_require__(59),_flatten3=_interopRequireDefault(_flatten2),_union2=__webpack_require__(62),_union3=_interopRequireDefault(_union2),_forEach2=__webpack_require__(22),_forEach3=_interopRequireDefault(_forEach2),_map2=__webpack_require__(23),_map3=_interopRequireDefault(_map2),_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_path=__webpack_require__(6),_path2=_interopRequireDefault(_path),_fs=__webpack_require__(11),_fs2=_interopRequireDefault(_fs),_mkdirp=__webpack_require__(205),_mkdirp2=_interopRequireDefault(_mkdirp),_flagUtils=__webpack_require__(75);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var Modelkit=function(){function a(){_classCallCheck(this,a)}return _createClass(a,[{key:'run',value:function run(b){var c=this;this.readFiles(b);var d=this.getFlags(b),e=this.getFreezeFlags(b.plugins),f=(0,_flagUtils.getBooleanFlagPermutations)(d,e),g=(0,_flagUtils.sortFlags)(f);(0,_mkdirp2.default)(b.outputDir);var h=(0,_map3.default)(g,function(j,k){return{flags:j,directory:c.getDirectoryByFlag({flagObj:j,flagIndex:k,config:b})}});_fs2.default.writeFileSync(_path2.default.join(b.outputDir,'mapping.json'),JSON.stringify(h,null,2)),(0,_forEach3.default)(g,function(j,k){c.applyFlags({flagObj:j,flagIndex:k,config:b})})}},{key:'applyFlags',value:function applyFlags(b){var c=b.flagObj,d=b.flagIndex,e=b.config,f=Object.assign({},c),g=this.getDirectoryByFlag({flagObj:c,flagIndex:d,config:e}),h=_path2.default.join(e.outputDir,g);(0,_mkdirp2.default)(h),(0,_forEach3.default)(e.input,function(j){return j.applyFlags(f,h)})}},{key:'getDirectoryByFlag',value:function getDirectoryByFlag(b){var c=b.flagIndex,d=b.config,e=d.flagDirName.replace('[id]',c);return e}},{key:'getFlags',value:function getFlags(b){var c=(0,_union3.default)((0,_flatten3.default)((0,_map3.default)(b.input,function(d){return d.getFlags()})));return c}},{key:'readFiles',value:function readFiles(b){(0,_forEach3.default)(b.input,function(c){return c.readFiles(b.inputDir)})}},{key:'getFreezeFlags',value:function getFreezeFlags(b){var c=(0,_map3.default)(b,function(e){return e.getFreezeFlags()}),d=(0,_reduce3.default)(c,function(e,f){return Object.assign(e,f)},{});return d}}]),a}();exports.default=Modelkit;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _modelkitFreezePlugin=__webpack_require__(74);Object.defineProperty(exports,'ModelkitFreezePlugin',{enumerable:!0,get:function get(){return _interopRequireDefault(_modelkitFreezePlugin).default}});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _modelkit=__webpack_require__(68);Object.defineProperty(exports,'default',{enumerable:!0,get:function get(){return _interopRequireDefault(_modelkit).default}});var _plugins=__webpack_require__(69);Object.keys(_plugins).forEach(function(a){'default'===a||'__esModule'===a||Object.defineProperty(exports,a,{enumerable:!0,get:function get(){return _plugins[a]}})});var _loaders=__webpack_require__(67);Object.keys(_loaders).forEach(function(a){'default'===a||'__esModule'===a||Object.defineProperty(exports,a,{enumerable:!0,get:function get(){return _loaders[a]}})});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}
...
"use strict";
var _forEach2=__webpack_require__(22),_forEach3=_interopRequireDefault(_forEach2),_flatten2=__webpack_require__(59),_flatten3=_interopRequireDefault(_flatten2),_union2=__webpack_require__(62),_union3=_interopRequireDefault(_union2),_map2=__webpack_require__(23),_map3=_interopRequireDefault(_map2),_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_fs=__webpack_require__(11),_fs2=_interopRequireDefault(_fs),_path=__webpack_require__(6),_path2=_interopRequireDefault(_path),_grasp=__webpack_require__(144),_grasp2=_interopRequireDefault(_grasp);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var JsLoader=function(){function a(b){_classCallCheck(this,a),this.config=b}return _createClass(a,[{key:'readFiles',value:function readFiles(b){var c=this.config.flagFunction+'(_str, _bool)';this.files=(0,_map3.default)(this.config.files,function(d){var e=_path2.default.join(b,d),f=_fs2.default.readFileSync(e,'utf8'),g=_grasp2.default.search('equery',c,f),h=(0,_map3.default)(g,function(j){return j.arguments[0].value});return{fileName:d,filePath:e,flags:h,source:f}})}},{key:'getFlags',value:function getFlags(){var b=(0,_union3.default)((0,_flatten3.default)((0,_map3.default)(this.files,function(c){return c.flags})));return b}},{key:'applyFlags',value:function applyFlags(b,c){var d=this.config.flagFunction+'(_str, _bool)';(0,_forEach3.default)(this.files,function(e){var f=e.fileName,g=e.source,h=_grasp2.default.replace('equery',d,function(j,k){return JSON.stringify(b[k.arguments[0].value])},g);_fs2.default.writeFileSync(_path2.default.join(c,f),h)})}}]),a}();exports.default=JsLoader;
...
"use strict";
var _filter2=__webpack_require__(58),_filter3=_interopRequireDefault(_filter2),_reduce2=__webpack_require__(30),_reduce3=_interopRequireDefault(_reduce2),_map2=__webpack_require__(23),_map3=_interopRequireDefault(_map2),_forEach2=__webpack_require__(22),_forEach3=_interopRequireDefault(_forEach2),_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_fs=__webpack_require__(11),_fs2=_interopRequireDefault(_fs),_path=__webpack_require__(6),_path2=_interopRequireDefault(_path),_isPlainObject=__webpack_require__(61),_isPlainObject2=_interopRequireDefault(_isPlainObject);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var deleteProperty=function(a,b){(0,_forEach3.default)(b,function(c,d){var e=a[d];'undefined'==typeof e||((0,_isPlainObject2.default)(c)&&(0,_isPlainObject2.default)(e)?deleteProperty(e,c):delete a[d])})},updateProperty=function(a,b){(0,_forEach3.default)(b,function(c,d){var e=a[d];return'undefined'==typeof e?void(a[d]=c):void((0,_isPlainObject2.default)(c)&&(0,_isPlainObject2.default)(e)?updateProperty(e,c):a[d]=c)})},JsonLoader=function(){function a(b){_classCallCheck(this,a),this.config=b}return _createClass(a,[{key:'readFiles',value:function readFiles(b){this.files=(0,_map3.default)(this.config.files,function(c){var d=_path2.default.join(b,c),e=_fs2.default.readFileSync(d,'utf8');return{fileName:c,filePath:d,source:e}})}},{key:'getFlags',value:function getFlags(){var b=(0,_map3.default)(this.config.changes,function(c){return c.flag});return b}},{key:'applyFlags',value:function applyFlags(b,c){var d=this;(0,_forEach3.default)(this.files,function(e){var f=e.fileName,g=e.source,h=JSON.parse(g);h=(0,_reduce3.default)(b,function(j,k,l){if(!k)return j;var m=(0,_filter3.default)(d.config.changes,function(n){return n.flag===l})[0];return'undefined'==typeof m?j:(m.delete&&deleteProperty(j,m.delete),m.update&&updateProperty(j,m.update),j)},h),_fs2.default.writeFileSync(_path2.default.join(c,f),JSON.stringify(h,null,2))})}}]),a}();exports.default=JsonLoader;
...
"use strict";
var _filter2=__webpack_require__(58),_filter3=_interopRequireDefault(_filter2),_reduce2=__webpack_require__(30),_reduce3=_interopRequireDefault(_reduce2),_map2=__webpack_require__(23),_map3=_interopRequireDefault(_map2),_forEach2=__webpack_require__(22),_forEach3=_interopRequireDefault(_forEach2),_createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,'value'in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_fs=__webpack_require__(11),_fs2=_interopRequireDefault(_fs),_path=__webpack_require__(6),_path2=_interopRequireDefault(_path),_isPlainObject=__webpack_require__(61),_isPlainObject2=_interopRequireDefault(_isPlainObject),_parse=__webpack_require__(222),_parse2=_interopRequireDefault(_parse),_stringify=__webpack_require__(223),_stringify2=_interopRequireDefault(_stringify);Object.defineProperty(exports,'__esModule',{value:!0});function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var deleteProperty=function(a,b){(0,_forEach3.default)(b,function(c,d){var e=a[d];'undefined'==typeof e||((0,_isPlainObject2.default)(c)&&(0,_isPlainObject2.default)(e)?deleteProperty(e,c):delete a[d])})},updateProperty=function(a,b){(0,_forEach3.default)(b,function(c,d){var e=a[d];return'undefined'==typeof e?void(a[d]=c):void((0,_isPlainObject2.default)(c)&&(0,_isPlainObject2.default)(e)?updateProperty(e,c):a[d]=c)})},YarnLoader=function(){function a(b){_classCallCheck(this,a),this.config=b}return _createClass(a,[{key:'readFiles',value:function readFiles(b){this.files=(0,_map3.default)(this.config.files,function(c){var d=_path2.default.join(b,c),e=_fs2.default.readFileSync(d,'utf8').replace(/\r\n/g,'\n');return{fileName:c,filePath:d,source:e}})}},{key:'getFlags',value:function getFlags(){var b=(0,_map3.default)(this.config.changes,function(c){return c.flag});return b}},{key:'applyFlags',value:function applyFlags(b,c){var d=this;(0,_forEach3.default)(this.files,function(e){var f=e.fileName,g=e.filePath,h=e.source,j=(0,_parse2.default)(h,g);j=(0,_reduce3.default)(b,function(k,l,m){if(!l)return k;var n=(0,_filter3.default)(d.config.changes,function(o){return o.flag===m})[0];return'undefined'==typeof n?k:(n.delete&&deleteProperty(k,n.delete),n.update&&updateProperty(k,n.update),k)},j),_fs2.default.writeFileSync(_path2.default.join(c,f),(0,_stringify2.default)(j,!1))})}}]),a}();exports.default=YarnLoader;
...
"use strict";
var _createClass=function(){function a(b,c){for(var e,d=0;d<c.length;d++)e=c[d],e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(b,e.key,e)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();Object.defineProperty(exports,"__esModule",{value:!0});function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}var FreezePlugin=function(){function a(b){_classCallCheck(this,a),this.config=b}return _createClass(a,[{key:"getFreezeFlags",value:function getFreezeFlags(){return this.config.flags}}]),a}();exports.default=FreezePlugin;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var getFlagBits=exports.getFlagBits=function(a,b){for(var c=0,d=0;d<a.length;d+=1)b[a[d]]&&(c+=1<<d);return c},getBooleanFlagPermutations=exports.getBooleanFlagPermutations=function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},c=Object.assign({},b),d=[],e=function changeFlagByIndex(f){if(f>=a.length)d.push(Object.assign({},c));else{var g=a[f];'undefined'==typeof b[g]?(c[g]=!1,e(f+1),c[g]=!0,e(f+1)):e(f+1)}};return e(0),d},sortFlags=exports.sortFlags=function(a){return a};
...
var object        = __webpack_require__(120)
  , stringifiable = __webpack_require__(45)
...
var d              = __webpack_require__(3)
  ...
  , primitiveSet   = __webpack_require__(119)
  , setPrototypeOf = __webpack_require__(26)
  , memoize        = __webpack_require__(63)
  , memoizeMethods = __webpack_require__(198)

  , sgr = __webpack_require__(36)
  , mods = sgr.mods
...
if (process.platform === 'win32') xtermMatch = __webpack_require__(83);
...
var from              = __webpack_require__(12)
  ...
  , getStrippedLength = __webpack_require__(25);
...
module.exports = Object.defineProperties(__webpack_require__(77), {
	windowSize: d(__webpack_require__(88)),
	erase: d(__webpack_require__(80)),
	move: d(__webpack_require__(84)),
	beep: d(__webpack_require__(78)),
	columns: d(__webpack_require__(79)),
	strip: d(__webpack_require__(37)),
	getStrippedLength: d(__webpack_require__(25)),
	slice: d(__webpack_require__(86)),
	throbber: d(__webpack_require__(87)),
	reset: d(__webpack_require__(85)),
	art: d(__webpack_require__(76))
});
...
colors = __webpack_require__(82).map(function (color) {
	return {
...
var reAnsi        = __webpack_require__(35)
  , stringifiable = __webpack_require__(45)
...
var compose      = __webpack_require__(99)
  , callable     = __webpack_require__(0)
  , d            = __webpack_require__(3)
  , validTimeout = __webpack_require__(65)
...
var copy             = __webpack_require__(112)
  ...
  , ensureCallable   = __webpack_require__(0)
  , map              = __webpack_require__(13)
  , callable         = __webpack_require__(0)
...
var isArguments    = __webpack_require__(16)
  , isString       = __webpack_require__(20)
  , ArrayIterator  = __webpack_require__(126)
  , StringIterator = __webpack_require__(130)
  , iterable       = __webpack_require__(131)
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;(function() {
  ...
  // amd
  if ("function" !== "undefined" && __webpack_require__(217) !== null && __webpack_require__(218)) {
...
(function(){
  ...
  ref$ = __webpack_require__(8), primitiveOnlyAttributes = ref$.primitiveOnlyAttributes, eitherAttributes = ref$.eitherAttributes, syntaxFlat = ref$.syntaxFlat;
  ref$ = __webpack_require__(2), all = ref$.all, tail = ref$.tail;
  getNodeAtPath = __webpack_require__(47).getNodeAtPath;
...
(function(){
  ...
  acorn = __webpack_require__(24);
  ref$ = __webpack_require__(8), aliasMap = ref$.aliasMap, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap, literalMap = ref$.literalMap;
  getNodeAtPath = __webpack_require__(47).getNodeAtPath;
...
(function(){
  ...
  ref$ = __webpack_require__(2), map = ref$.map, any = ref$.any, all = ref$.all;
  ref$ = __webpack_require__(8), literalMap = ref$.literalMap, syntaxFlat = ref$.syntaxFlat;
  ref$ = __webpack_require__(49), Cache = ref$.Cache, visitPre = ref$.visitPre, visitChildren = ref$.visitChildren, getPath = ref$.getPath;
...
(function(){
  ...
  ref$ = __webpack_require__(2), map = ref$.map, last = ref$.last, lines = ref$.lines, compact = ref$.compact, join = ref$.join;
  ref$ = __webpack_require__(8), aliasMap = ref$.aliasMap, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap, literalMap = ref$.literalMap, complexTypeMap = ref$.complexTypeMap, attrMap = ref$.attrMap, primitiveOnlyAttributes = ref$.primitiveOnlyAttributes, eitherAttributes = ref$.eitherAttributes;
  function parse(selector){
...
(function(){
  ...
  ref$ = __webpack_require__(2), id = ref$.id, compact = ref$.compact, unlines = ref$.unlines, min = ref$.min, max = ref$.max;
  module.exports = {
...
(function(){
  ...
  ref$ = __webpack_require__(2), map = ref$.map, flatten = ref$.flatten, join = ref$.join, lines = ref$.lines, unlines = ref$.unlines, chars = ref$.chars, unchars = ref$.unchars;
  ref$ = __webpack_require__(8), syntax = ref$.syntax, syntaxFlat = ref$.syntaxFlat, aliasMap = ref$.aliasMap, attrMapInverse = ref$.attrMapInverse, matchesMap = ref$.matchesMap, matchesAliasMap = ref$.matchesAliasMap;
  pad = __webpack_require__(146).pad;
  options = __webpack_require__(51).options;
...
(function(){
  ...
  acorn = __webpack_require__(24);
  squery = __webpack_require__(50);
  equery = __webpack_require__(48);
  async = __webpack_require__(147);
  ref$ = __webpack_require__(2), min = ref$.min, sortWith = ref$.sortWith, lines = ref$.lines, chars = ref$.chars, split = ref$.split, join = ref$.join, map = ref$.map, Obj = ref$.Obj;
  format = __webpack_require__(142), formatResult = format.formatResult, formatName = format.formatName, formatCount = format.formatCount;
  replace = __webpack_require__(145).replace;
  ref$ = __webpack_require__(51), parseOptions = ref$.parse, generateHelp = ref$.generateHelp, generateHelpForOption = ref$.generateHelpForOption;
  help = __webpack_require__(143);
  _console = console;
  version = '0.4.0';
  run = function(arg$){
    ...
    ref$ = arg$ != null
      ...
      ? ref1$
      : __webpack_require__(11), textFormat = (ref1$ = ref$.textFormat) != null
      ? ref1$
      : __webpack_require__(81), input = ref$.input, console = (ref1$ = ref$.console) != null ? ref1$ : _console;
    if (args == null) {
    ...
    queryEngine = options.engine != null
      ? __webpack_require__(34)(options.engine)
      : options.squery
        ? squery
    ...
    ref$ = (function(){
      ...
      default:
        return [__webpack_require__(34)(options.parser[0]), options.parser[1]];
      }
...
(function(){
  ...
  ref$ = __webpack_require__(2), lines = ref$.lines, unlines = ref$.unlines, filter = ref$.filter, fold = ref$.fold, capitalize = ref$.capitalize, camelize = ref$.camelize, dasherize = ref$.dasherize;
  levn = __webpack_require__(53);
...
(function(){
  ...
  parsedTypeCheck = __webpack_require__(33).parsedTypeCheck;
  types = {
...
(function(){
  ...
  reject = __webpack_require__(2).reject;
...
var aFrom        = __webpack_require__(12)
  , objectMap    = __webpack_require__(13)
  , mixin        = __webpack_require__(42)
  , defineLength = __webpack_require__(38)
  , nextTick     = __webpack_require__(32)
...
var aFrom      = __webpack_require__(12)
  , forEach    = __webpack_require__(7)
  , nextTick   = __webpack_require__(32)
  , isPromise  = __webpack_require__(52)
  , timeout    = __webpack_require__(65)
  , extensions = __webpack_require__(5)
...
var toPosInteger = __webpack_require__(4)
  , lruQueue     = __webpack_require__(187)
  , extensions   = __webpack_require__(5);
...
var objectMap = __webpack_require__(13)
  , isPromise = __webpack_require__(52)
  , nextTick  = __webpack_require__(32)
...
var customError      = __webpack_require__(98)
  , defineLength     = __webpack_require__(38)
  , d                = __webpack_require__(3)
  , ee               = __webpack_require__(136).methods
  , resolveResolve   = __webpack_require__(197)
  , resolveNormalize = __webpack_require__(196)
...
module.exports = __webpack_require__(195)(__webpack_require__(63));
...
var callable      = __webpack_require__(0)
  , forEach       = __webpack_require__(7)
  , extensions    = __webpack_require__(5)
  , configure     = __webpack_require__(194)
  , resolveLength = __webpack_require__(31)
...
(function(){
  ...
  ref$ = __webpack_require__(2), id = ref$.id, find = ref$.find, sort = ref$.sort, min = ref$.min, max = ref$.max, map = ref$.map, unlines = ref$.unlines;
  ref$ = __webpack_require__(64), nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin;
  wordwrap = __webpack_require__(220);
...
(function(){
  ...
  VERSION = '0.8.2';
  ref$ = __webpack_require__(2), id = ref$.id, map = ref$.map, compact = ref$.compact, any = ref$.any, groupBy = ref$.groupBy, partition = ref$.partition, chars = ref$.chars, isItNaN = ref$.isItNaN, keys = ref$.keys, Obj = ref$.Obj, camelize = ref$.camelize;
  deepIs = __webpack_require__(91);
  ref$ = __webpack_require__(64), closestString = ref$.closestString, nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin;
  ref$ = __webpack_require__(206), generateHelp = ref$.generateHelp, generateHelpForOption = ref$.generateHelpForOption;
  ref$ = __webpack_require__(33), parsedTypeCheck = ref$.parsedTypeCheck, parseType = ref$.parseType;
  parseLevn = __webpack_require__(53).parsedTypeParse;
...
(function(){
  ...
  ref$ = __webpack_require__(2), any = ref$.any, all = ref$.all, isItNaN = ref$.isItNaN;
  types = {
    Number: {
      typeOf: 'Number',
...
function _load_constants() {
  return _constants = __webpack_require__(66);
}

var _errors;

function _load_errors() {
  return _errors = __webpack_require__(221);
}

var _map;

function _load_map() {
  return _map = _interopRequireDefault(__webpack_require__(224));
}

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const invariant = __webpack_require__(148);
/* eslint quotes: 0 */

const stripBOM = __webpack_require__(213);
...
function _load_misc() {
  return _misc = __webpack_require__(225);
}
...
const _camelCase = __webpack_require__(228);
...
function _load_rootUser() {
  return _rootUser = _interopRequireDefault(__webpack_require__(226));
}
...
const userHomeDir = process.platform === 'linux' && (_rootUser || _load_rootUser()).default ? path.resolve('/usr/local/share') : __webpack_require__(229).homedir();
