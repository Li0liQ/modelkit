(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("modelkit", ["path", "fs"], factory);
	else if(typeof exports === 'object')
		exports["modelkit"] = factory(require("path"), require("fs"));
	else
		root["modelkit"] = factory(root["path"], root["fs"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_45__, __WEBPACK_EXTERNAL_MODULE_161__) {
...
var _modelkitJsonLoader = __webpack_require__(51);
...
var _modelkitJsLoader = __webpack_require__(50);
...
var _modelkitYarnLoader = __webpack_require__(52);
...
var _foreach = __webpack_require__(147);
...
var _flagUtils = __webpack_require__(54);
...
var Modelkit = function () {
    ...
    _createClass(Modelkit, [{
        ...
        value: function run(config) {
            ...
            var flags = this.getFlags(config);
            var freezeFlags = this.getFreezeFlags(config.plugins);
            var flagPermutations = (0, _flagUtils.getBooleanFlagPermutations)(flags, freezeFlags);

            // TODO: allow plugins to sort flags the way they want
            var sortedFlags = (0, _flagUtils.sortFlags)(flagPermutations);

            (0, _mkdirp2.default)(config.outputDir);

            // Write a plugin that will create a manifest file.
            var featureFlagsToDirectoryMap = (0, _map2.default)(sortedFlags, function (flagObj, flagIndex) {
                return {
                    flags: flagObj,
                    directory: _this.getDirectoryByFlag({ flagObj: flagObj, flagIndex: flagIndex, config: config })
                };
            });

            _fs2.default.writeFileSync(_path2.default.join(config.outputDir, 'mapping.json'), JSON.stringify(featureFlagsToDirectoryMap, null, 2));

            (0, _foreach2.default)(sortedFlags, function (flagObj, flagIndex) {
                _this.applyFlags({ flagObj: flagObj, flagIndex: flagIndex, config: config });
            });
        }
    }, {
        key: 'applyFlags',
        value: function applyFlags(_ref) {
            ...
            var outputDir = _path2.default.join(config.outputDir, config.flagDirName.replace('[id]', flagIndex));

            (0, _mkdirp2.default)(outputDir);
            (0, _foreach2.default)(config.input, function (i) {
                return i.applyFlags(flagCopy, outputDir);
            });
        }
    }, {
        key: 'getDirectoryByFlag',
        value: function getDirectoryByFlag(_ref2) {
            var flagObj = _ref2.flagObj,
                flagIndex = _ref2.flagIndex,
                config = _ref2.config;
        ...
        key: 'getFlags',
        value: function getFlags(config) {
            // we support only boolean flags for now
            // hence union and returning flag names only works fine
            var flags = (0, _union2.default)((0, _flatten2.default)((0, _map2.default)(config.input, function (i) {
                return i.getFlags();
            })));
        ...
        value: function readFiles(config) {
            (0, _foreach2.default)(config.input, function (i) {
                return i.readFiles(config.inputDir);
            });
        }
    }, {
        key: 'getFreezeFlags',
        value: function getFreezeFlags(input) {
            ...
            // Throw if there are.
            var freezeFlags = (0, _map2.default)(input, function (i) {
                return i.getFreezeFlags();
            });

            var uniqueFreezeFlags = (0, _reduce2.default)(freezeFlags, function (agg, i) {
...
var _modelkitFreezePlugin = __webpack_require__(53);
...
var _modelkit = __webpack_require__(47);
...
var _loaders = __webpack_require__(46);
...
var JsLoader = function () {
    ...
    _createClass(JsLoader, [{
        ...
        value: function getFlags() {
            var flags = (0, _union2.default)((0, _flatten2.default)((0, _map2.default)(this.files, function (i) {
                return i.flags;
            })));
        ...
        key: 'applyFlags',
        value: function applyFlags(flagObj, outputDir) {
            (0, _foreach2.default)(this.files, function (_ref) {
                var fileName = _ref.fileName,
                    filePath = _ref.filePath,
                    flags = _ref.flags,
                    source = _ref.source;

                _fs2.default.writeFileSync(_path2.default.join(outputDir, fileName), source);
            });
        }
    }]);
...
var deleteProperty = function deleteProperty(obj, pattern) {
    (0, _foreach2.default)(pattern, function (value, key) {
        var subObj = obj[key];
...
var JsonLoader = function () {
    ...
    _createClass(JsonLoader, [{
        ...
        key: 'getFlags',
        value: function getFlags() {
            var flags = (0, _map2.default)(this.config.changes, function (i) {
                return i.flag;
            });
        ...
        value: function applyFlags(flagObj, outputDir) {
            ...
            (0, _foreach2.default)(this.files, function (_ref) {
                ...
                json = (0, _reduce2.default)(flagObj, function (agg, value, key) {
                    if (!value) {
                        return agg;
                    }

                    var changes = (0, _filter2.default)(_this.config.changes, function (i) {
                        return i.flag === key;
                    })[0];
                ...
                _fs2.default.writeFileSync(_path2.default.join(outputDir, fileName), JSON.stringify(json, null, 2));
            });
        }
    }]);
...
var YarnPlugin = function () {
    function YarnPlugin(config) {
        _classCallCheck(this, YarnPlugin);

        this.config = config;
    }

    _createClass(YarnPlugin, [{
        key: 'readFiles',
        value: function readFiles(inputDir) {
            this.files = (0, _map2.default)(this.config.files, function (fileName, index) {
                var filePath = _path2.default.join(inputDir, fileName);
                var source = _fs2.default.readFileSync(filePath, 'utf8');
                // TODO: Read flags
                var flags = ['yarn-1', 'yarn-2', 'common-1', 'common-2'];
...
var SetCache = __webpack_require__(24),
    ...
    arrayIncludesWith = __webpack_require__(64),
    cacheHas = __webpack_require__(32),
...
var baseFlatten = __webpack_require__(28),
    ...
    baseUniq = __webpack_require__(92),
